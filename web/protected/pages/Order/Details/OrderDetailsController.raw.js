			...
			.insert({'bottom': new Element('div', {'class': 'list-group'})
				...
				.insert({'bottom': new Element('a', {'class': 'list-group-item'}).setStyle('padding: 3px 0px;')
					.insert({'bottom': new Element('div', {'class': 'row'})
						...
						.insert({'bottom': new Element('div', {'class': 'col-xs-2'}).update( tmp.me.getCurrency(tmp.me._order.totalAmount) ) })
						.insert({'bottom': new Element('div', {'class': 'col-xs-6', 'style':'font-weight: 700;'}).update( tmp.me._order.gstFree == true ? 'GST Free': '' ) })
					})
				})
				.insert({'bottom': new Element('a', {'class': 'list-group-item'}).setStyle('padding: 3px 0px;')
					.insert({'bottom': new Element('div', {'class': 'row'})
