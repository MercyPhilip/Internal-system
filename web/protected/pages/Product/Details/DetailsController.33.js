...
PageJs.prototype = Object.extend(new DetailsPageJs(), {
    ...
    ,_getFullDescriptionPanel: function(item) {
            ...
            .observe('click', function(){
                ...
                if(!item.fullDescriptionAsset && !tmp.me._readOnlyMode) {
                    ...
                    $$('.fullDescriptionEl').first().replace(
                        new Element('div', {'class': 'col-sm-12'}).update(tmp.me._getFormGroup('Synopsis:', new Element('input', {'type': 'text', 'disabled': true, 'value': ''}) ) )
                    );
                }
                else {
                    jQuery.ajax({
                        ...
                        success: function(result) {
                            ...
                            if(!tmp.me._readOnlyMode) {
                                ...
                                $$('.fullDescriptionEl').first().replace(
                                    new Element('div', {'class': 'col-sm-12'}).update(tmp.me._getFormGroup('Synopsis:', new Element('input', {'type': 'text', 'disabled': true, 'value': result ? result : ''}) ) )
                                )
                            }
                        }
                    })
        ...
        tmp.newDiv = tmp.me._getFormGroup('Synopsis:', tmp.loadFullBtn);
        return tmp.newDiv;
    }
    /**
    ...
    ,_getcustomTabPanel: function(item) {
            ...
            .observe('click', function(){
                ...
                if(!item.customTabAsset && !tmp.me._readOnlyMode) {
                    ...
                    $$('.customTabEl').first().replace(
                        new Element('div', {'class': 'col-sm-12'}).update(tmp.me._getFormGroup('Extra Features:', new Element('input', {'type': 'text', 'disabled': true, 'value': ''}) ) )
                    );
                }
                else {
                    jQuery.ajax({
                        ...
                        success: function(result) {
                            ...
                            if(!tmp.me._readOnlyMode) {
                                ...
                                $$('.customTabEl').first().replace(
                                    new Element('div', {'class': 'col-sm-12'}).update(tmp.me._getFormGroup('Extra Features:', new Element('input', {'type': 'text', 'disabled': true, 'value': result ? result : ''}) ) )
                                )
                            }
                        }
                    })
        ...
        tmp.newDiv = tmp.me._getFormGroup('Extra Features:', tmp.loadFullBtn);
        return tmp.newDiv;
    }
    /**
        ...
        tmp.newDiv = new Element('div', {'class': 'panel panel-default'})
            ...
            .insert({'bottom': new Element('div', {'class': 'panel-body'})
                ...
                .insert({'bottom': new Element('div', {'class': ''})
                    ...
                    .insert({'bottom': new Element('div', {'class': 'col-sm-3'}).update(tmp.me._getFormGroup('Release Date:', new Element('input', {'class': 'datepicker', 'required': true, 'type': 'date', 'save-item': 'releaseDate', 'value': tmp.item.movieInfo.releaseDate ? moment(tmp.item.movieInfo.releaseDate).format('DD/MM/YYYY') : ''}) ) ) })
                })
                .insert({'bottom': new Element('div', {'class': ''})
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Alias:', new Element('input', {'save-item': 'alias', 'type': 'text', 'value': tmp.item.movieInfo.alias ? tmp.item.movieInfo.alias : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Director:', new Element('input', {'save-item': 'director', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.director ? tmp.item.movieInfo.director : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Actor Names:', new Element('input', {'save-item': 'actorName', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.actorName ? tmp.item.movieInfo.actorName : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Language:', new Element('input', {'save-item': 'language', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.language ? tmp.item.movieInfo.language : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Subtitle:', new Element('input', {'save-item': 'subtitle', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.subtitle ? tmp.item.movieInfo.subtitle : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Year Of Production:', new Element('input', {'save-item': 'yearOfProduction', 'type': 'text', 'value': tmp.item.movieInfo.yearOfProduction ? tmp.item.movieInfo.yearOfProduction : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Product Type:', new Element('input', {'save-item': 'productType', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.productType ? tmp.item.movieInfo.productType : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Rating:', new Element('input', {'save-item': 'rating', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.colorFormat ? tmp.item.movieInfo.colorFormat : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Audio Format:', new Element('input', {'save-item': 'audioFormat', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.audioFormat ? tmp.item.movieInfo.audioFormat : ''}) ) ) })
                })
                .insert({'bottom': new Element('div', {'class': ''})
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Format Name:', new Element('input', {'save-item': 'formatName', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.formatName ? tmp.item.movieInfo.formatName : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Color Format:', new Element('input', {'save-item': 'colorFormat', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.colorFormat ? tmp.item.movieInfo.colorFormat : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Contract Region:', new Element('input', {'save-item': 'contractRegion', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.contractRegion ? tmp.item.movieInfo.contractRegion : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Trailer:', new Element('input', {'save-item': 'trailer', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.trailer ? tmp.item.movieInfo.trailer : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Running Time:', new Element('input', {'save-item': 'runningTime', 'required': true,'type': 'text', 'value': parseFloat(tmp.item.movieInfo.runningTime)>0 ? tmp.item.movieInfo.runningTime : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Aspect Ratio:', new Element('input', {'save-item': 'aspectRatio', 'required': true,'type': 'text', 'value': tmp.item.movieInfo.aspectRatio ? tmp.item.movieInfo.aspectRatio : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Number Of Disc:', new Element('input', {'save-item': 'numberOfDisc', 'required': true,'type': 'text', 'value': parseFloat(tmp.item.movieInfo.numberOfDisc)>0 ? tmp.item.movieInfo.numberOfDisc : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Weight:', new Element('input', {'save-item': 'weight', 'required': true,'type': 'text', 'value': parseFloat(tmp.item.weight)>0 ? tmp.item.weight : ''}) ) ) })
                })
                .insert({'bottom': new Element('div', {'class': ''})
                    .insert({'bottom': new Element('div', {'class': 'col-sm-12'}).update(tmp.me._getFormGroup('Short Description:', new Element('input', {'save-item': 'shortDescription', 'required': true,'type': 'text', 'value': tmp.item.shortDescription ? tmp.item.shortDescription : ''}) ) ) })
                })
                .insert({'bottom': new Element('div', {'class': ''})
    ...
    ,_bindDatePicker: function() {
        ...
        $$('.datepicker').each(function(item){
            if(!item.hasClassName('datepicked')) {
                ...
                tmp.picker = new Prado.WebUI.TDatePicker({'ID': item.id, 'InputMode':"TextBox",'Format':"dd/MM/yyyy",'FirstDayOfWeek':1,'CalendarStyle':"default",'FromYear':2009,'UpToYear':2024,'PositionMode':"Bottom", "ClassName": 'datepicker-layer-fixer'});
