        ...
        tmp.newDiv = new Element('div', {'class': 'panel panel-default'})
            ...
            .insert({'bottom': new Element('div', {'class': 'panel-body'})
                ...
                .insert({'bottom': new Element('div', {'class': ''})
                    ...
                    .insert({'bottom': new Element('div', {'class': 'col-sm-3'}).update(tmp.me._getFormGroup('Release Date:', new Element('input', {'class': 'datepicker', 'required': true, 'type': 'date', 'save-item': 'releaseDate', 'value': tmp.item.movieInfo ? moment(tmp.item.movieInfo.releaseDate).format('DD/MM/YYYY') : ''}) ) ) })
                })
                .insert({'bottom': new Element('div', {'class': ''})
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Alias:', new Element('input', {'save-item': 'alias', 'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.alias : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Director:', new Element('input', {'save-item': 'director', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.director : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Actor Names:', new Element('input', {'save-item': 'actorName', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.actorName : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Language:', new Element('input', {'save-item': 'language', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.language : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Subtitle:', new Element('input', {'save-item': 'subtitle', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.subtitle : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Year Of Production:', new Element('input', {'save-item': 'yearOfProduction', 'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.yearOfProduction : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Product Type:', new Element('input', {'save-item': 'productType', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.productType : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Rating:', new Element('input', {'save-item': 'rating', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.colorFormat : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Audio Format:', new Element('input', {'save-item': 'audioFormat', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.audioFormat : ''}) ) ) })
                })
                .insert({'bottom': new Element('div', {'class': ''})
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Format Name:', new Element('input', {'save-item': 'formatName', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.formatName : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Color Format:', new Element('input', {'save-item': 'colorFormat', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.colorFormat : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Contract Region:', new Element('input', {'save-item': 'contractRegion', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.contractRegion : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-2'}).update(tmp.me._getFormGroup('Trailer:', new Element('input', {'save-item': 'trailer', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.trailer : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Running Time:', new Element('input', {'save-item': 'runningTime', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.runningTime : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Aspect Ratio:', new Element('input', {'save-item': 'aspectRatio', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.aspectRatio : ''}) ) ) })
                    .insert({'bottom': new Element('div', {'class': 'col-sm-1'}).update(tmp.me._getFormGroup('Number Of Disc:', new Element('input', {'save-item': 'numberOfDisc', 'required': true,'type': 'text', 'value': tmp.item.movieInfo ? tmp.item.movieInfo.numberOfDisc : ''}) ) ) })
