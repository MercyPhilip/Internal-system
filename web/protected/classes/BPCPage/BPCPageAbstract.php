...
abstract class BPCPageAbstract extends TPage
{
	...
	public function __construct()
	{
	    parent::__construct();
	     ...
	     {
	     	if(isset($_REQUEST['user']) && isset($_REQUEST['pass']) && in_array(get_class($this), array('OrderPrintController', 'POPrintController', 'CreditNotePrintController')) && ($userAccount = UserAccount::getUserByUsernameAndPassword(trim($_REQUEST['user']), trim($_REQUEST['pass']), true)) instanceof UserAccount)
