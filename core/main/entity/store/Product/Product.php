...
class Product extends InfoEntityAbstract
{
	...
	/**
	 * Whether this product local only
	 *
	 * @var bool
	 */
	...
	public function getProductEta()
	{
		...
		{
			$etas = ProductEta::getAllByCriteria('productId = ? and received = 0', array($this->getId()),true);
			if(count($etas) > 0) {
